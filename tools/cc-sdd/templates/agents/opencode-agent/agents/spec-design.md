...
- **Suggested Action**: "Run `/yy-spec-design {feature} -y` to auto-approve requirements and proceed"

**Missing Requirements**:
- **Stop Execution**: Requirements document must exist
- **User Message**: "No requirements.md found at `{{KIRO_DIR}}/specs/{feature}/requirements.md`"
- **Suggested Action**: "Run `/yy-spec-requirements {feature}` to generate requirements first"
